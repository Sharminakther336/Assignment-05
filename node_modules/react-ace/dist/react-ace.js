(function(global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.ReactAce = {}), global.React));
	...
	var require_ace = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		*/
		(function() {
			...
			var define = function(module$3, deps, payload) {
				if (typeof module$3 !== "string") {
				...
				if (!define.modules[module$3]) {
					define.payloads[module$3] = payload;
					define.modules[module$3] = null;
				}
			};
			define.modules = {};
			define.payloads = {};
			...
			*/
			var _require = function(parentId, module$4, callback) {
				if (typeof module$4 === "string") {
					var payload = lookup(parentId, module$4);
					if (payload != void 0) {
						callback && callback();
						return payload;
					}
				} else if (Object.prototype.toString.call(module$4) === "[object Array]") {
					var params = [];
					for (var i = 0, l = module$4.length; i < l; ++i) {
						var dep = lookup(parentId, module$4[i]);
			...
			var require = function(module$5, callback) {
				var packagedModule = _require("", module$5, callback);
			...
			*/
			var lookup = function(parentId, moduleName) {
				...
				var module$6 = define.modules[moduleName];
				if (!module$6) {
					module$6 = define.payloads[moduleName];
					if (typeof module$6 === "function") {
						var exports$3 = {};
						var mod = {
							id: moduleName,
							uri: "",
						...
						var req = function(module$7, callback) {
							return _require(moduleName, module$7, callback);
						};
						exports$3 = module$6(req, exports$3, mod) || mod.exports;
						define.modules[moduleName] = exports$3;
						delete define.payloads[moduleName];
					}
					module$6 = define.modules[moduleName] = exports$3 || module$6;
				}
				return module$6;
			};
		...
		ace.define("ace/lib/es6-shim", [
			...
			"exports",
			"module"
		], function(require, exports$4, module$8) {
		...
		ace.define("ace/lib/fixoldbrowsers", [
			...
			"module",
			"ace/lib/es6-shim"
		], function(require, exports$5, module$9) {
			"use strict";
			require("./es6-shim");
		});
		ace.define("ace/lib/deep_copy", [
			...
			"exports",
			"module"
		], function(require, exports$6, module$10) {
			exports$6.deepCopy = function deepCopy(obj) {
		...
		ace.define("ace/lib/lang", [
			...
			"module",
			"ace/lib/deep_copy"
		], function(require, exports$7, module$11) {
			"use strict";
			exports$7.last = function(a) {
				return a[a.length - 1];
			};
			exports$7.stringReverse = function(string) {
				return string.split("").reverse().join("");
			};
			exports$7.stringRepeat = function(string, count) {
				var result = "";
				while (count > 0) {
					if (count & 1) result += string;
					if (count >>= 1) string += string;
			...
			exports$7.stringTrimLeft = function(string) {
				return string.replace(trimBeginRegexp, "");
			};
			exports$7.stringTrimRight = function(string) {
				return string.replace(trimEndRegexp, "");
			};
			exports$7.copyObject = function(obj) {
				var copy = {};
				for (var key in obj) copy[key] = obj[key];
				return copy;
			};
			exports$7.copyArray = function(array) {
				var copy = [];
				for (var i = 0, l = array.length; i < l; i++) if (array[i] && typeof array[i] == "object") copy[i] = this.copyObject(array[i]);
				else copy[i] = array[i];
				return copy;
			};
			exports$7.deepCopy = require("./deep_copy").deepCopy;
			exports$7.arrayToMap = function(arr) {
				var map = {};
				for (var i = 0; i < arr.length; i++) map[arr[i]] = 1;
				return map;
			};
			exports$7.createMap = function(props) {
				var map = Object.create(null);
				for (var i in props) map[i] = props[i];
				return map;
			};
			exports$7.arrayRemove = function(array, value) {
				for (var i = 0; i <= array.length; i++) if (value === array[i]) array.splice(i, 1);
			};
			exports$7.escapeRegExp = function(str) {
				return str.replace(/([.*+?^${}()|[\]\/\\])/g, "\\$1");
			};
			exports$7.escapeHTML = function(str) {
				return ("" + str).replace(/&/g, "&#38;").replace(/"/g, "&#34;").replace(/'/g, "&#39;").replace(/</g, "&#60;");
			};
			exports$7.getMatchOffsets = function(string, regExp) {
				var matches = [];
			...
			exports$7.deferredCall = function(fcn) {
				var timer = null;
			...
			exports$7.delayedCall = function(fcn, defaultTimeout) {
				var timer = null;
				var callback = function() {
					timer = null;
					fcn();
			...
			exports$7.sleep = function(ms) {
				return new Promise(function(resolve) {
					setTimeout(resolve, ms);
				});
			};
			exports$7.supportsLookbehind = function() {
				return true;
			};
			exports$7.skipEmptyMatch = function(line, last, supportsUnicodeFlag) {
		...
		ace.define("ace/lib/useragent", [
			...
			"exports",
			"module"
		], function(require, exports$8, module$12) {
			"use strict";
			exports$8.OS = {
				LINUX: "LINUX",
				MAC: "MAC",
			...
			exports$8.getOS = function() {
				if (exports$8.isMac) return exports$8.OS.MAC;
				else if (exports$8.isLinux) return exports$8.OS.LINUX;
				else return exports$8.OS.WINDOWS;
			};
			var _navigator = typeof navigator == "object" ? navigator : {};
			var os = (/mac|win|linux/i.exec(_navigator.platform) || ["other"])[0].toLowerCase();
			var ua = _navigator.userAgent || "";
			var appName = _navigator.appName || "";
			exports$8.isWin = os == "win";
			exports$8.isMac = os == "mac";
			exports$8.isLinux = os == "linux";
			exports$8.isIE = appName == "Microsoft Internet Explorer" || appName.indexOf("MSAppHost") >= 0 ? parseFloat((ua.match(/(?:MSIE |Trident\/[0-9]+[\.0-9]+;.*rv:)([0-9]+[\.0-9]+)/) || [])[1]) : parseFloat((ua.match(/(?:Trident\/[0-9]+[\.0-9]+;.*rv:)([0-9]+[\.0-9]+)/) || [])[1]);
			exports$8.isOldIE = exports$8.isIE && exports$8.isIE < 9;
			exports$8.isGecko = exports$8.isMozilla = ua.match(/ Gecko\/\d+/);
			exports$8.isOpera = typeof opera == "object" && Object.prototype.toString.call(window["opera"]) == "[object Opera]";
			exports$8.isWebKit = parseFloat(ua.split("WebKit/")[1]) || void 0;
			exports$8.isChrome = parseFloat(ua.split(" Chrome/")[1]) || void 0;
			exports$8.isSafari = parseFloat(ua.split(" Safari/")[1]) && !exports$8.isChrome || void 0;
			exports$8.isEdge = parseFloat(ua.split(" Edge/")[1]) || void 0;
			exports$8.isAIR = ua.indexOf("AdobeAIR") >= 0;
			exports$8.isAndroid = ua.indexOf("Android") >= 0;
			exports$8.isChromeOS = ua.indexOf(" CrOS ") >= 0;
			exports$8.isIOS = /iPad|iPhone|iPod/.test(ua) && !window["MSStream"];
			if (exports$8.isIOS) exports$8.isMac = true;
			exports$8.isMobile = exports$8.isIOS || exports$8.isAndroid;
		});
		ace.define("ace/lib/dom", [
			...
			"module",
			"ace/lib/useragent"
		], function(require, exports$9, module$13) {
			"use strict";
			var useragent = require("./useragent");
			var XHTML_NS = "http://www.w3.org/1999/xhtml";
			exports$9.buildDom = function buildDom(arr, parent, refs) {
			...
			exports$9.getDocumentHead = function(doc) {
				if (!doc) doc = document;
				return doc.head || doc.getElementsByTagName("head")[0] || doc.documentElement;
			};
			exports$9.createElement = function(tag, ns) {
				return document.createElementNS ? document.createElementNS(ns || XHTML_NS, tag) : document.createElement(tag);
			};
			exports$9.removeChildren = function(element) {
				element.innerHTML = "";
			};
			exports$9.createTextNode = function(textContent, element) {
				return (element ? element.ownerDocument : document).createTextNode(textContent);
			};
			exports$9.createFragment = function(element) {
				return (element ? element.ownerDocument : document).createDocumentFragment();
			};
			exports$9.hasCssClass = function(el, name) {
				return (el.className + "").split(/\s+/g).indexOf(name) !== -1;
			};
			exports$9.addCssClass = function(el, name) {
				if (!exports$9.hasCssClass(el, name)) el.className += " " + name;
			};
			exports$9.removeCssClass = function(el, name) {
			...
			exports$9.toggleCssClass = function(el, name) {
			...
			exports$9.setCssClass = function(node, className, include) {
				if (include) exports$9.addCssClass(node, className);
				else exports$9.removeCssClass(node, className);
			};
			exports$9.hasCssString = function(id, doc) {
				var index = 0, sheets;
				doc = doc || document;
			...
			exports$9.removeElementById = function(id, doc) {
				doc = doc || document;
				if (doc.getElementById(id)) doc.getElementById(id).remove();
			};
			var strictCSP;
			var cssCache = [];
			exports$9.useStrictCSP = function(value) {
				strictCSP = value;
			...
			function importCssString(cssText, id, target) {
				...
				if (id && exports$9.hasCssString(id, container)) return null;
				if (id) cssText += "\n/*# sourceURL=ace/css/" + id + " */";
				var style = exports$9.createElement("style");
				style.appendChild(doc.createTextNode(cssText));
				if (id) style.id = id;
				if (container == doc) container = exports$9.getDocumentHead(doc);
				container.insertBefore(style, container.firstChild);
			}
			exports$9.importCssString = importCssString;
			exports$9.importCssStylsheet = function(uri, doc) {
				exports$9.buildDom(["link", {
					rel: "stylesheet",
					href: uri
				}], exports$9.getDocumentHead(doc));
			};
			exports$9.$fixPositionBug = function(el) {
			...
			exports$9.scrollbarWidth = function(doc) {
				var inner = exports$9.createElement("ace_inner");
				inner.style.width = "100%";
				inner.style.minWidth = "0px";
				inner.style.height = "200px";
				inner.style.display = "block";
				var outer = exports$9.createElement("ace_outer");
			...
			exports$9.computedStyle = function(element, style) {
				return window.getComputedStyle(element, "") || {};
			};
			exports$9.setStyle = function(styles, property, value) {
				if (styles[property] !== value) styles[property] = value;
			};
			exports$9.HAS_CSS_ANIMATION = false;
			exports$9.HAS_CSS_TRANSFORMS = false;
			exports$9.HI_DPI = useragent.isWin ? typeof window !== "undefined" && window.devicePixelRatio >= 1.5 : true;
			if (useragent.isChromeOS) exports$9.HI_DPI = false;
			if (typeof document !== "undefined") {
				var div = document.createElement("div");
				if (exports$9.HI_DPI && div.style.transform !== void 0) exports$9.HAS_CSS_TRANSFORMS = true;
				if (!useragent.isEdge && typeof div.style.animationName !== "undefined") exports$9.HAS_CSS_ANIMATION = true;
				div = null;
			}
			if (exports$9.HAS_CSS_TRANSFORMS) exports$9.translate = function(element, tx, ty) {
				element.style.transform = "translate(" + Math.round(tx) + "px, " + Math.round(ty) + "px)";
			};
			else exports$9.translate = function(element, tx, ty) {
		...
		ace.define("ace/lib/net", [
			...
			"module",
			"ace/lib/dom"
		], function(require, exports$10, module$14) {
			/*
			* based on code from:
			*
			...
			*/
			"use strict";
			var dom = require("./dom");
			exports$10.get = function(url, callback) {
			...
			exports$10.loadScript = function(path, callback) {
			...
			exports$10.qualifyURL = function(url) {
		...
		ace.define("ace/lib/oop", [
			...
			"exports",
			"module"
		], function(require, exports$11, module$15) {
			"use strict";
			exports$11.inherits = function(ctor, superCtor) {
			...
			exports$11.mixin = function(obj, mixin) {
				for (var key in mixin) obj[key] = mixin[key];
				return obj;
			};
			exports$11.implement = function(proto, mixin) {
				exports$11.mixin(proto, mixin);
			};
		});
		ace.define("ace/lib/event_emitter", [
			...
			"exports",
			"module"
		], function(require, exports$12, module$16) {
			"use strict";
			var EventEmitter = {};
			...
			exports$12.EventEmitter = EventEmitter;
		});
		ace.define("ace/lib/report_error", [
			"require",
			"exports",
			"module"
		], function(require, exports$13, module$17) {
			exports$13.reportError = function reportError(msg, data) {
				var e = new Error(msg);
				e["data"] = data;
		...
		ace.define("ace/lib/default_english_messages", [
			...
			"exports",
			"module"
		], function(require, exports$14, module$18) {
			exports$14.defaultEnglishMessages = {
		...
		], function(require, exports$15, module$19) {
			"no use strict";
			var oop = require("./oop");
		...
		ace.define("ace/theme/textmate", [
			...
			"ace/lib/dom"
		], function(require, exports$17, module$21) {
			"use strict";
			exports$17.isDark = false;
			exports$17.cssClass = "ace-tm";
			exports$17.cssText = require("./textmate-css");
			exports$17.$id = "ace/theme/textmate";
			require("../lib/dom").importCssString(exports$17.cssText, exports$17.cssClass, false);
		});
		ace.define("ace/config", [
			...
			"ace/lib/app_config",
			"ace/theme/textmate"
		], function(require, exports$18, module$22) {
			"no use strict";
			var lang = require("./lib/lang");
			var net = require("./lib/net");
			var dom = require("./lib/dom");
			var AppConfig = require("./lib/app_config").AppConfig;
			module$22.exports = exports$18 = new AppConfig();
			var options = {
				packaged: false,
				workerPath: null,
				modePath: null,
			...
			exports$18.all = function() {
				return lang.copyObject(options);
			};
			exports$18.$modes = {};
			exports$18.moduleUrl = function(name, component) {
			...
			exports$18.setModuleUrl = function(name, subst) {
			...
			var customLoader;
			exports$18.setLoader = function(cb) {
				customLoader = cb;
			};
			exports$18.dynamicModules = Object.create(null);
			exports$18.$loading = {};
			exports$18.$loaded = {};
			exports$18.loadModule = function(moduleId, onLoad) {
				var loadedModule;
				if (Array.isArray(moduleId)) {
					var moduleType = moduleId[0];
					var moduleName = moduleId[1];
				} else if (typeof moduleId == "string") var moduleName = moduleId;
				var load = function(module$23) {
					if (module$23 && !exports$18.$loading[moduleName]) return onLoad && onLoad(module$23);
					if (!exports$18.$loading[moduleName]) exports$18.$loading[moduleName] = [];
					exports$18.$loading[moduleName].push(onLoad);
					if (exports$18.$loading[moduleName].length > 1) return;
					var afterLoad = function() {
						loader(moduleName, function(err, module$24) {
							if (module$24) exports$18.$loaded[moduleName] = module$24;
							exports$18._emit("load.module", {
								name: moduleName,
								module: module$24
							});
							var listeners = exports$18.$loading[moduleName];
							exports$18.$loading[moduleName] = null;
							listeners.forEach(function(onLoad) {
								onLoad && onLoad(module$24);
							});
						});
					};
					if (!exports$18.get("packaged")) return afterLoad();
					net.loadScript(exports$18.moduleUrl(moduleName, moduleType), afterLoad);
					reportErrorIfPathIsNotConfigured();
				};
				if (exports$18.dynamicModules[moduleName]) exports$18.dynamicModules[moduleName]().then(function(module$25) {
					if (module$25.default) load(module$25.default);
					else load(module$25);
				});
				else {
					try {
					...
					load(loadedModule || exports$18.$loaded[moduleName]);
				}
			};
			exports$18.$require = function(moduleName) {
				if (typeof module$22["require"] == "function") return module$22["require"](moduleName);
			};
			exports$18.setModuleLoader = function(moduleName, onLoad) {
				exports$18.dynamicModules[moduleName] = onLoad;
			};
		...
		ace.define("ace/loader_build", [
			...
			"ace/config"
		], function(require, exports$19, module$26) {
			"use strict";
			require("./lib/fixoldbrowsers");
			var config = require("./config");
			config.setLoader(function(moduleName, cb) {
				require([moduleName], function(module$27) {
					cb(null, module$27);
				});
			});
			var global = (function() {
			...
			module$26.exports = function(ace) {
				config.init = init;
			...
			function init(packaged) {
				...
				config.set("packaged", packaged || require.packaged || module$26.packaged || global.define && define.packaged);
				var scriptOptions = {};
				var scriptUrl = "";
		...
		ace.define("ace/range", [
			...
			"exports",
			"module"
		], function(require, exports$20, module$28) {
			"use strict";
			var Range = function() {
		...
		ace.define("ace/lib/keys", [
			...
			"module",
			"ace/lib/oop"
		], function(require, exports$21, module$29) {
			"use strict";
			var oop = require("./oop");
			var Keys = {
				MODIFIER_KEYS: {
			...
			exports$21.$codeToKeyCode = codeToKeyCode;
			...
			oop.mixin(exports$21, Keys);
			exports$21.default = exports$21;
			exports$21.keyCodeToString = function(keyCode) {
		...
		ace.define("ace/lib/event", [
			...
			"ace/lib/keys",
			"ace/lib/useragent"
		], function(require, exports$22, module$30) {
			"use strict";
			...
			var addListener = exports$22.addListener = function(elem, type, callback, destroyer) {
				elem.addEventListener(type, callback, getListenerOptions());
				if (destroyer) destroyer.$toDestroy.push(new EventListener(elem, type, callback));
			};
			var removeListener = exports$22.removeListener = function(elem, type, callback) {
				elem.removeEventListener(type, callback, getListenerOptions());
			};
			exports$22.stopEvent = function(e) {
				exports$22.stopPropagation(e);
				exports$22.preventDefault(e);
				return false;
			};
			exports$22.stopPropagation = function(e) {
				if (e.stopPropagation) e.stopPropagation();
			};
			exports$22.preventDefault = function(e) {
				if (e.preventDefault) e.preventDefault();
			};
			exports$22.getButton = function(e) {
				if (e.type == "dblclick") return 0;
				if (e.type == "contextmenu" || useragent.isMac && e.ctrlKey && !e.altKey && !e.shiftKey) return 2;
				return e.button;
			};
			exports$22.capture = function(el, eventHandler, releaseCaptureHandler) {
			...
			exports$22.addMouseWheelListener = function(el, callback, destroyer) {
			...
			exports$22.addMultiMouseDownListener = function(elements, timeouts, eventHandler, callbackName, destroyer) {
				var clicks = 0;
				...
				function onMousedown(e) {
					if (exports$22.getButton(e) !== 0) clicks = 0;
					else if (e.detail > 1) {
						clicks++;
			...
			exports$22.getModifierString = function(e) {
			...
			exports$22.addCommandKeyListener = function(el, callback, destroyer) {
			...
			if (typeof window == "object" && window.postMessage && !useragent.isOldIE) {
				var postMessageId = 1;
				exports$22.nextTick = function(callback, win) {
					win = win || window;
			...
			exports$22.$idleBlocked = false;
			exports$22.onIdle = function(cb, timeout) {
				return setTimeout(function handler() {
					if (!exports$22.$idleBlocked) cb();
					else setTimeout(handler, 100);
				}, timeout);
			};
			exports$22.$idleBlockId = null;
			exports$22.blockIdle = function(delay) {
				if (exports$22.$idleBlockId) clearTimeout(exports$22.$idleBlockId);
				exports$22.$idleBlocked = true;
				exports$22.$idleBlockId = setTimeout(function() {
					exports$22.$idleBlocked = false;
				}, delay || 100);
			};
			exports$22.nextFrame = typeof window == "object" && (window.requestAnimationFrame || window["mozRequestAnimationFrame"] || window["webkitRequestAnimationFrame"] || window["msRequestAnimationFrame"] || window["oRequestAnimationFrame"]);
			if (exports$22.nextFrame) exports$22.nextFrame = exports$22.nextFrame.bind(window);
			else exports$22.nextFrame = function(callback) {
		...
		ace.define("ace/clipboard", [
			...
			"exports",
			"module"
		], function(require, exports$23, module$31) {
			"use strict";
			var $cancelT;
			module$31.exports = {
				lineMode: false,
		...
		ace.define("ace/keyboard/textinput", [
			...
			"ace/clipboard",
			"ace/lib/keys"
		], function(require, exports$24, module$32) {
			"use strict";
			...
			exports$24.$setUserAgentForTests = function(_isMobile, _isIOS) {
				isMobile = _isMobile;
				isIOS = _isIOS;
			};
		});
		ace.define("ace/mouse/default_handlers", [
			...
			"module",
			"ace/lib/useragent"
		], function(require, exports$25, module$33) {
			"use strict";
			var useragent = require("../lib/useragent");
			var DRAG_OFFSET = 0;
			...
			exports$25.DefaultHandlers = DefaultHandlers;
		...
		ace.define("ace/mouse/mouse_event", [
			...
			"ace/lib/event",
			"ace/lib/useragent"
		], function(require, exports$26, module$34) {
			"use strict";
			var event = require("../lib/event");
			var useragent = require("../lib/useragent");
			exports$26.MouseEvent = function() {
		...
		ace.define("ace/lib/scroll", [
			...
			"exports",
			"module"
		], function(require, exports$27, module$35) {
			exports$27.preventParentScroll = function preventParentScroll(event) {
		...
		ace.define("ace/tooltip", [
			...
			"ace/range",
			"ace/lib/scroll"
		], function(require, exports$28, module$36) {
			"use strict";
			...
			exports$28.popupManager = popupManager;
			exports$28.Tooltip = Tooltip;
			exports$28.HoverTooltip = function(_super) {
		...
		ace.define("ace/mouse/default_gutter_handler", [
			...
			"ace/config",
			"ace/range"
		], function(require, exports$29, module$37) {
			"use strict";
			var __extends = this && this.__extends || (function() {
				var extendStatics = function(d, b) {
					extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
			...
			exports$29.GutterHandler = GutterHandler;
			...
			GutterTooltip.$uid = 0;
			exports$29.GutterTooltip = GutterTooltip;
		});
		ace.define("ace/mouse/dragdrop_handler", [
			...
			"ace/lib/event",
			"ace/lib/useragent"
		], function(require, exports$30, module$38) {
			"use strict";
			var dom = require("../lib/dom");
			var event = require("../lib/event");
			var useragent = require("../lib/useragent");
			...
			exports$30.DragdropHandler = DragdropHandler;
		});
		ace.define("ace/mouse/touch_handler", [
			...
			"ace/lib/event",
			"ace/lib/dom"
		], function(require, exports$31, module$39) {
			"use strict";
			var MouseEvent = require("./mouse_event").MouseEvent;
			var event = require("../lib/event");
			var dom = require("../lib/dom");
			exports$31.addTouchListeners = function(el, editor) {
				var mode = "scroll";
				var startX;
				var startY;
				var touchStartT;
		...
		ace.define("ace/mouse/mouse_handler", [
			...
			"ace/config"
		], function(require, exports$32, module$40) {
			"use strict";
			var event = require("../lib/event");
			var useragent = require("../lib/useragent");
			...
			exports$32.MouseHandler = MouseHandler;
		});
		ace.define("ace/mouse/fold_handler", [
			...
			"module",
			"ace/lib/dom"
		], function(require, exports$33, module$41) {
			"use strict";
			var dom = require("../lib/dom");
			exports$33.FoldHandler = function() {
		...
		ace.define("ace/keyboard/keybinding", [
			...
			"ace/lib/keys",
			"ace/lib/event"
		], function(require, exports$34, module$42) {
			"use strict";
			var keyUtil = require("../lib/keys");
			var event = require("../lib/event");
			exports$34.KeyBinding = function() {
		...
		ace.define("ace/lib/bidiutil", [
			...
			"exports",
			"module"
		], function(require, exports$35, module$43) {
			"use strict";
			...
			exports$35.RLE = 7;
			exports$35.DOT = "·";
			exports$35.doBidiReorder = function(text, textCharTypes, isRtl) {
				...
				for (var i = 0; i < logicalFromVisual.length - 1; i++) if (textCharTypes[i] === AN) levels[i] = exports$35.AN;
				else if (levels[i] === R && (textCharTypes[i] > AL && textCharTypes[i] < LRE || textCharTypes[i] === ON || textCharTypes[i] === BN)) levels[i] = exports$35.ON_R;
				else if (i > 0 && chars[i - 1] === "ل" && /\u0622|\u0623|\u0625|\u0627/.test(chars[i])) {
					levels[i - 1] = levels[i] = exports$35.R_H;
					i++;
				}
				if (chars[chars.length - 1] === exports$35.DOT) levels[chars.length - 1] = exports$35.B;
				if (chars[0] === "‫") levels[0] = exports$35.RLE;
			...
			exports$35.hasBidiCharacters = function(text, textCharTypes) {
				var ret = false;
			...
			exports$35.getVisualFromLogicalIdx = function(logIdx, rowMap) {
		...
		ace.define("ace/bidihandler", [
			...
			"ace/lib/bidiutil",
			"ace/lib/lang"
		], function(require, exports$36, module$44) {
			"use strict";
			var bidiUtil = require("./lib/bidiutil");
			var lang = require("./lib/lang");
			var bidiRE = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\u202B]/;
			exports$36.BidiHandler = function() {
		...
		ace.define("ace/selection", [
			...
			exports$37.Selection = Selection;
		});
		ace.define("ace/tokenizer", [
			...
			exports$38.Tokenizer = Tokenizer;
		});
		ace.define("ace/mode/text_highlight_rules", [
			...
			exports$39.TextHighlightRules = TextHighlightRules;
		});
		ace.define("ace/mode/behaviour", [
			...
			exports$40.Behaviour = Behaviour;
		});
		ace.define("ace/token_iterator", [
			...
			"use strict";
			var Range = require("./range").Range;
			exports$41.TokenIterator = function() {
		...
		ace.define("ace/mode/behaviour/cstyle", [
			...
			exports$42.CstyleBehaviour = CstyleBehaviour;
		});
		ace.define("ace/unicode", [
			...
			exports$43.wordChars = String.fromCharCode.apply(null, str);
		});
		...
		ace.define("ace/line_widgets", [
			...
			"use strict";
			var dom = require("./lib/dom");
			exports$45.LineWidgets = function() {
		...
		ace.define("ace/apply_delta", [
			...
			"use strict";
			exports$46.applyDelta = function(docLines, delta, doNotValidate) {
		...
		ace.define("ace/background_tokenizer", [
			...
			exports$49.BackgroundTokenizer = BackgroundTokenizer;
		});
		ace.define("ace/search_highlight", [
			...
			exports$50.SearchHighlight = SearchHighlight;
		});
		ace.define("ace/undomanager", [
			...
			exports$51.UndoManager = UndoManager;
		});
		...
		ace.define("ace/range_list", [
			...
			exports$53.RangeList = RangeList;
		});
		...
		ace.define("ace/edit_session/bracket_match", [
			...
			exports$56.BracketMatch = BracketMatch;
		});
		ace.define("ace/edit_session", [
			...
			exports$57.EditSession = EditSession;
		});
		...
		ace.define("ace/keyboard/hash_handler", [
			...
			exports$59.HashHandler = HashHandler;
			exports$59.MultiHashHandler = MultiHashHandler;
		});
		ace.define("ace/commands/command_manager", [
			...
			exports$60.CommandManager = CommandManager;
		});
		ace.define("ace/commands/default_commands", [
			...
			exports$61.commands = [
				{
					...
					exec: function(editor) {
						config.loadModule("ace/ext/settings_menu", function(module$70) {
							module$70.init(editor);
				...
				},
				{
					...
					exec: function(editor) {
						config.loadModule("ace/ext/error_marker", function(module$71) {
							module$71.showErrorMarker(editor, 1);
						});
					},
				...
				},
				{
					...
					exec: function(editor) {
						config.loadModule("ace/ext/error_marker", function(module$72) {
							module$72.showErrorMarker(editor, -1);
						});
					},
					scrollIntoView: "animate",
					readOnly: true
			...
			for (var i = 1; i < 9; i++) exports$61.commands.push({
				name: "foldToLevel" + i,
		...
		ace.define("ace/keyboard/gutter_handler", [
			...
			"module",
			"ace/lib/keys"
		], function(require, exports$62, module$73) {
			"use strict";
			var keys = require("../lib/keys");
			exports$62.GutterKeyboardHandler = function() {
			...
			exports$62.GutterKeyboardEvent = GutterKeyboardEvent;
		});
		ace.define("ace/editor", [
			...
			"ace/lib/event",
			"ace/tooltip"
		], function(require, exports$63, module$74) {
			"use strict";
			var __values = this && this.__values || function(o) {
				var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
				if (m) return m.call(o);
			...
			var Editor = function() {
				...
				Editor.prototype.setKeyboardHandler = function(keyboardHandler, cb) {
					if (keyboardHandler && typeof keyboardHandler === "string" && keyboardHandler != "ace") {
						...
						var _self = this;
						config.loadModule(["keybinding", keyboardHandler], function(module$75) {
							if (_self.$keybindingId == keyboardHandler) _self.keyBinding.setKeyboardHandler(module$75 && module$75.handler);
							cb && cb();
						});
					} else {
				...
				Editor.prototype.prompt = function(message, options, callback) {
					var editor = this;
					config.loadModule("ace/ext/prompt", function(module$76) {
						module$76.prompt(editor, message, options, callback);
					});
				};
		...
		ace.define("ace/layer/lines", [
			...
			"module",
			"ace/lib/dom"
		], function(require, exports$64, module$77) {
			"use strict";
			var dom = require("../lib/dom");
			exports$64.Lines = function() {
		...
		ace.define("ace/layer/gutter", [
			...
			"ace/layer/lines",
			"ace/config"
		], function(require, exports$65, module$78) {
			"use strict";
			var dom = require("../lib/dom");
			var oop = require("../lib/oop");
			var lang = require("../lib/lang");
		...
		ace.define("ace/layer/marker", [
			...
			"ace/range",
			"ace/lib/dom"
		], function(require, exports$66, module$79) {
			"use strict";
			var Range = require("../range").Range;
			var dom = require("../lib/dom");
			var Marker = function() {
			...
			exports$66.Marker = Marker;
		});
		ace.define("ace/layer/text_util", [
			"require",
			"exports",
			"module"
		], function(require, exports$67, module$80) {
			var textTokens = /* @__PURE__ */ new Set([
				"text",
				"rparen",
				"lparen"
			]);
			exports$67.isTextToken = function(tokenType) {
		...
		ace.define("ace/layer/text", [
			...
			"ace/config",
			"ace/layer/text_util"
		], function(require, exports$68, module$81) {
			"use strict";
			var oop = require("../lib/oop");
			var dom = require("../lib/dom");
			var lang = require("../lib/lang");
		...
		ace.define("ace/layer/cursor", [
			...
			"module",
			"ace/lib/dom"
		], function(require, exports$69, module$82) {
			"use strict";
			var dom = require("../lib/dom");
			var Cursor = function() {
		...
		ace.define("ace/scrollbar", [
			...
			"ace/lib/event",
			"ace/lib/event_emitter"
		], function(require, exports$70, module$83) {
			"use strict";
			var __extends = this && this.__extends || (function() {
				var extendStatics = function(d, b) {
					extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
			...
			exports$70.ScrollBar = VScrollBar;
			exports$70.ScrollBarV = VScrollBar;
			exports$70.ScrollBarH = HScrollBar;
			exports$70.VScrollBar = VScrollBar;
			exports$70.HScrollBar = HScrollBar;
		});
		ace.define("ace/scrollbar_custom", [
			...
			"ace/lib/event",
			"ace/lib/event_emitter"
		], function(require, exports$71, module$84) {
			"use strict";
			var __extends = this && this.__extends || (function() {
				var extendStatics = function(d, b) {
					extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
			...
			exports$71.ScrollBar = VScrollBar;
			exports$71.ScrollBarV = VScrollBar;
			exports$71.ScrollBarH = HScrollBar;
			exports$71.VScrollBar = VScrollBar;
			exports$71.HScrollBar = HScrollBar;
		});
		ace.define("ace/renderloop", [
			...
			"module",
			"ace/lib/event"
		], function(require, exports$72, module$85) {
			"use strict";
			var event = require("./lib/event");
			exports$72.RenderLoop = function() {
		...
		ace.define("ace/layer/font_metrics", [
			...
			"ace/lib/useragent",
			"ace/lib/event_emitter"
		], function(require, exports$73, module$86) {
			var oop = require("../lib/oop");
			var dom = require("../lib/dom");
			var lang = require("../lib/lang");
			var event = require("../lib/event");
			...
			exports$73.FontMetrics = FontMetrics;
		});
		ace.define("ace/css/editor-css", [
			"require",
			"exports",
			"module"
		], function(require, exports$74, module$87) {
		...
		ace.define("ace/layer/decorators", [
			...
			"ace/lib/oop",
			"ace/lib/event_emitter"
		], function(require, exports$75, module$88) {
			"use strict";
			var dom = require("../lib/dom");
			var oop = require("../lib/oop");
			var EventEmitter = require("../lib/event_emitter").EventEmitter;
			...
			exports$75.Decorator = Decorator;
		});
		ace.define("ace/virtual_renderer", [
			...
			"ace/lib/useragent",
			"ace/layer/text_util"
		], function(require, exports$76, module$89) {
			"use strict";
			var oop = require("./lib/oop");
			var dom = require("./lib/dom");
			var lang = require("./lib/lang");
			...
			var VirtualRenderer = function() {
				...
				VirtualRenderer.prototype.setTheme = function(theme, cb) {
					...
					function afterLoad(module$90) {
						if (_self.$themeId != theme) return cb && cb();
						if (!module$90 || !module$90.cssClass) throw new Error("couldn't load module " + theme + " or it didn't call define");
						if (module$90.$id) _self.$themeId = module$90.$id;
						dom.importCssString(module$90.cssText, module$90.cssClass, _self.container);
						if (_self.theme) dom.removeCssClass(_self.container, _self.theme.cssClass);
						var padding = "padding" in module$90 ? module$90.padding : "padding" in (_self.theme || {}) ? 4 : _self.$padding;
						if (_self.$padding && padding != _self.$padding) _self.setPadding(padding);
						if (_self.$gutterLayer) {
							var showGutterCursor = module$90["$showGutterCursorMarker"];
						...
						_self.$theme = module$90.cssClass;
						_self.theme = module$90;
						dom.addCssClass(_self.container, module$90.cssClass);
						dom.setCssClass(_self.container, "ace_dark", module$90.isDark);
						if (_self.$size) {
							_self.$size.width = 0;
							_self.$updateSizeAsync();
						}
						_self._dispatchEvent("themeLoaded", { theme: module$90 });
						cb && cb();
			...
			exports$76.VirtualRenderer = VirtualRenderer;
		});
		ace.define("ace/worker/worker_client", [
			...
			"ace/lib/event_emitter",
			"ace/config"
		], function(require, exports$77, module$91) {
			"use strict";
			var oop = require("../lib/oop");
			var net = require("../lib/net");
			var EventEmitter = require("../lib/event_emitter").EventEmitter;
			...
			exports$77.UIWorkerClient = UIWorkerClient;
			exports$77.WorkerClient = WorkerClient;
			exports$77.createWorker = createWorker;
		});
		ace.define("ace/placeholder", [
			...
			"ace/lib/event_emitter",
			"ace/lib/oop"
		], function(require, exports$78, module$92) {
			"use strict";
			var Range = require("./range").Range;
			var EventEmitter = require("./lib/event_emitter").EventEmitter;
			var oop = require("./lib/oop");
			...
			exports$78.PlaceHolder = PlaceHolder;
		});
		ace.define("ace/mouse/multi_select_handler", [
			...
			"ace/lib/event",
			"ace/lib/useragent"
		], function(require, exports$79, module$93) {
			var event = require("../lib/event");
			var useragent = require("../lib/useragent");
			...
			exports$79.onMouseDown = onMouseDown;
		});
		ace.define("ace/commands/multi_select_commands", [
			...
			"module",
			"ace/keyboard/hash_handler"
		], function(require, exports$80, module$94) {
			exports$80.defaultCommands = [
				{
					name: "addCursorAbove",
			...
			exports$80.multiSelectCommands = [{
			...
			exports$80.keyboardHandler = new HashHandler(exports$80.multiSelectCommands);
		});
		ace.define("ace/multi_select", [
			...
			"ace/editor",
			"ace/config"
		], function(require, exports$81, module$95) {
			...
			exports$81.commands = commands.defaultCommands.concat(commands.multiSelectCommands);
			var Search = require("./search").Search;
			...
			exports$81.onSessionChange = function(e) {
			...
			function MultiSelect(editor) {
				...
				editor.$multiselectOnSessionChange = exports$81.onSessionChange.bind(editor);
			...
			exports$81.MultiSelect = MultiSelect;
		...
		ace.define("ace/mode/folding/fold_mode", [
			...
			"module",
			"ace/range"
		], function(require, exports$82, module$96) {
			"use strict";
			var Range = require("../../range").Range;
			var FoldMode = exports$82.FoldMode = function() {};
			(function() {
		...
		ace.define("ace/ext/error_marker", [
			...
			"ace/range",
			"ace/config"
		], function(require, exports$83, module$97) {
			"use strict";
			var dom = require("../lib/dom");
			var Range = require("../range").Range;
			var nls = require("../config").nls;
			...
			exports$83.showErrorMarker = function(editor, dir) {
				var session = editor.session;
		...
		ace.define("ace/ace", [
			...
			"ace/config",
			"ace/loader_build"
		], function(require, exports$84, module$98) {
			"use strict";
			require("./loader_build")(exports$84);
			var dom = require("./lib/dom");
			var Range = require("./range").Range;
			var Editor = require("./editor").Editor;
			var EditSession = require("./edit_session").EditSession;
			...
			exports$84.config = require("./config");
			exports$84.edit = function(el, options) {
				if (typeof el == "string") {
					var _id = el;
				...
				var doc = exports$84.createEditSession(value);
			...
			exports$84.createEditSession = function(text, mode) {
				var doc = new EditSession(text, mode);
				doc.setUndoManager(new UndoManager());
				return doc;
			};
			exports$84.Range = Range;
			exports$84.Editor = Editor;
			exports$84.EditSession = EditSession;
			exports$84.UndoManager = UndoManager;
			exports$84.VirtualRenderer = Renderer;
			exports$84.version = exports$84.config.version;
		});
		(function() {
...
//#region src/ace.tsx
	...
	var ReactAce = class extends react.Component {
		...
		componentDidMount() {
			...
			if (onBeforeLoad) onBeforeLoad(ace$2);
		...
		componentDidUpdate(prevProps) {
			...
			if (!deepEqual(nextProps.setOptions, oldProps.setOptions)) this.handleOptions(nextProps);
			if (valueChanged || !deepEqual(nextProps.annotations, oldProps.annotations)) this.editor.getSession().setAnnotations(nextProps.annotations || []);
			const oldMarkers = oldProps.markers || [];
			const nextMarkers = nextProps.markers || [];
			if (!deepEqual(oldMarkers, nextMarkers)) this.handleMarkers(nextMarkers);
			if (!deepEqual(nextProps.scrollMargin, oldProps.scrollMargin)) this.handleScrollMargins(nextProps.scrollMargin);
		...
		handleMarkers(markers) {
			...
			markers.forEach(({ startRow, startCol, endRow, endCol, className, type, inFront = false }) => {
				const range = new import_ace.Range(startRow, startCol, endRow, endCol);
	...
	ReactAce.propTypes = {
		mode: import_prop_types.default.oneOfType([import_prop_types.default.string, import_prop_types.default.object]),
		...
		fontSize: import_prop_types.default.oneOfType([import_prop_types.default.number, import_prop_types.default.string]),
		lineHeight: import_prop_types.default.oneOfType([import_prop_types.default.number, import_prop_types.default.string]),
		showGutter: import_prop_types.default.bool,
		...
		onCursorChange: import_prop_types.default.func,
		onBeforeLoad: import_prop_types.default.func,
		onValidate: import_prop_types.default.func,
		minLines: import_prop_types.default.number,
		maxLines: import_prop_types.default.number,
		readOnly: import_prop_types.default.bool,
		highlightActiveLine: import_prop_types.default.bool,
		tabSize: import_prop_types.default.number,
		showPrintMargin: import_prop_types.default.bool,
		cursorStart: import_prop_types.default.number,
		debounceChangePeriod: import_prop_types.default.number,
		editorProps: import_prop_types.default.object,
		setOptions: import_prop_types.default.object,
		style: import_prop_types.default.object,
		scrollMargin: import_prop_types.default.array,
		annotations: import_prop_types.default.array,
		markers: import_prop_types.default.array,
		keyboardHandler: import_prop_types.default.string,
		wrapEnabled: import_prop_types.default.bool,
		enableSnippets: import_prop_types.default.bool,
		enableBasicAutocompletion: import_prop_types.default.oneOfType([import_prop_types.default.bool, import_prop_types.default.array]),
		enableLiveAutocompletion: import_prop_types.default.oneOfType([import_prop_types.default.bool, import_prop_types.default.array]),
		navigateToFileEnd: import_prop_types.default.bool,
		commands: import_prop_types.default.array,
...
//#endregion
//#region node_modules/ace-builds/src-noconflict/ext-split.js
	var require_ext_split = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		ace.define("ace/ext/split", [
			...
			"use strict";
			module$2.exports = require("../split");
		});
		(function() {
...
//#region src/split.tsx
	var import_ext_split = /* @__PURE__ */ __toESM(require_ext_split());
	const ace$1 = getAceInstance();
	const { Split } = import_ext_split.default;
	var SplitComponent = class extends react.Component {
		...
		componentDidMount() {
			...
			if (onBeforeLoad) onBeforeLoad(ace$1);
			const editorProps = Object.keys(this.props.editorProps);
			...
			split.forEach((editor, index) => {
				var _value$index, _annotations$index, _markers$index;
				for (let i = 0; i < editorProps.length; i++) editor[editorProps[i]] = this.props.editorProps[editorProps[i]];
				const defaultValueForEditor = defaultValue === null || defaultValue === void 0 ? void 0 : defaultValue[index];
				const valueForEditor = (_value$index = value === null || value === void 0 ? void 0 : value[index]) !== null && _value$index !== void 0 ? _value$index : "";
				...
				const newAnnotations = (_annotations$index = annotations === null || annotations === void 0 ? void 0 : annotations[index]) !== null && _annotations$index !== void 0 ? _annotations$index : [];
				const newMarkers = (_markers$index = markers === null || markers === void 0 ? void 0 : markers[index]) !== null && _markers$index !== void 0 ? _markers$index : [];
		...
		componentDidUpdate(prevProps) {
			...
			split.forEach((editor, index) => {
				var _nextProps$value$inde, _nextProps$value, _nextProps$annotation, _nextProps$annotation2, _oldProps$annotations, _oldProps$annotations2, _nextProps$markers$in, _nextProps$markers, _oldProps$markers$ind, _oldProps$markers;
				...
				if (!deepEqual(nextProps.setOptions, oldProps.setOptions)) this.handleOptions(nextProps, editor);
				const nextValue = (_nextProps$value$inde = (_nextProps$value = nextProps.value) === null || _nextProps$value === void 0 ? void 0 : _nextProps$value[index]) !== null && _nextProps$value$inde !== void 0 ? _nextProps$value$inde : "";
				...
				const newAnnotations = (_nextProps$annotation = (_nextProps$annotation2 = nextProps.annotations) === null || _nextProps$annotation2 === void 0 ? void 0 : _nextProps$annotation2[index]) !== null && _nextProps$annotation !== void 0 ? _nextProps$annotation : [];
				if (!deepEqual(newAnnotations, (_oldProps$annotations = (_oldProps$annotations2 = oldProps.annotations) === null || _oldProps$annotations2 === void 0 ? void 0 : _oldProps$annotations2[index]) !== null && _oldProps$annotations !== void 0 ? _oldProps$annotations : [])) editor.getSession().setAnnotations(newAnnotations);
				const newMarkers = (_nextProps$markers$in = (_nextProps$markers = nextProps.markers) === null || _nextProps$markers === void 0 ? void 0 : _nextProps$markers[index]) !== null && _nextProps$markers$in !== void 0 ? _nextProps$markers$in : [];
				if (!deepEqual(newMarkers, (_oldProps$markers$ind = (_oldProps$markers = oldProps.markers) === null || _oldProps$markers === void 0 ? void 0 : _oldProps$markers[index]) !== null && _oldProps$markers$ind !== void 0 ? _oldProps$markers$ind : []) && Array.isArray(newMarkers)) this.handleMarkers(newMarkers, editor);
			});
			if (nextProps.className !== oldProps.className) {
				const appliedClassesArray = this.refEditor.className.trim().split(" ");
				oldProps.className.trim().split(" ").forEach((oldClass) => {
	...
	SplitComponent.propTypes = {
		className: import_prop_types.default.string,
		debounceChangePeriod: import_prop_types.default.number,
		defaultValue: import_prop_types.default.arrayOf(import_prop_types.default.string),
		focus: import_prop_types.default.bool,
		fontSize: import_prop_types.default.oneOfType([import_prop_types.default.number, import_prop_types.default.string]),
		height: import_prop_types.default.string,
		mode: import_prop_types.default.string,
		name: import_prop_types.default.string,
		onBlur: import_prop_types.default.func,
		onChange: import_prop_types.default.func,
		onCopy: import_prop_types.default.func,
		...
		onPaste: import_prop_types.default.func,
		onScroll: import_prop_types.default.func,
		orientation: import_prop_types.default.string,
		showGutter: import_prop_types.default.bool,
		splits: import_prop_types.default.number,
		theme: import_prop_types.default.string,
		value: import_prop_types.default.arrayOf(import_prop_types.default.string),
		width: import_prop_types.default.string,
		onSelectionChange: import_prop_types.default.func,
		onCursorChange: import_prop_types.default.func,
		onBeforeLoad: import_prop_types.default.func,
...
//#endregion
//#region node_modules/diff-match-patch/index.js
	var require_diff_match_patch = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		/**
...
//#endregion
//#region src/diff.tsx
	var import_diff_match_patch = /* @__PURE__ */ __toESM(require_diff_match_patch());
	var DiffComponent = class extends react.Component {
		...
		render() {
			...
			return /* @__PURE__ */ react.createElement(SplitComponent, {
	...
	DiffComponent.propTypes = {
		cursorStart: import_prop_types.default.number,
		editorProps: import_prop_types.default.object,
		enableBasicAutocompletion: import_prop_types.default.bool,
		enableLiveAutocompletion: import_prop_types.default.bool,
		focus: import_prop_types.default.bool,
		fontSize: import_prop_types.default.number,
		height: import_prop_types.default.string,
		highlightActiveLine: import_prop_types.default.bool,
		maxLines: import_prop_types.default.number,
		minLines: import_prop_types.default.number,
...
//#endregion
//#region src/index.ts
	var src_default = ReactAce;

//#endregion
exports.default = src_default;
exports.diff = DiffComponent;
exports.split = SplitComponent;
});
